...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        // White/Light Text Colors Section
        array(
            'id'       => 'white_text_section',
            'type'     => 'section',
            'title'    => esc_html__('White & Light Text Colors', 'portfoliocraft'),
            'subtitle' => esc_html__('Configure white and light text colors used throughout the theme.', 'portfoliocraft'),
            'indent'   => true,
        ),
        array(
            'id'          => 'white_text_color',
            'type'        => 'color',
            'title'       => esc_html__('White Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Primary white text color used for text on dark backgrounds.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#ffffff',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'light_text_color',
            'type'        => 'color',
            'title'       => esc_html__('Light Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Light gray text color used for secondary text on dark backgrounds.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#f5f5f5',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'off_white_color',
            'type'        => 'color',
            'title'       => esc_html__('Off-White Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Slightly off-white color for softer contrast on dark backgrounds.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#fafafa',
            'validate'    => 'color',
        ),
        array(
            ...
            'subtitle'    => esc_html__('Light gray text color for muted text on dark backgrounds.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#e0e0e0',
            'validate'    => 'color',
        ),
        
        // Main Text Colors Section
        array(
            'id'       => 'main_text_section',
            'type'     => 'section',
            'title'    => esc_html__('Main Text Colors', 'portfoliocraft'),
            'subtitle' => esc_html__('Configure main text and heading colors used throughout the theme.', 'portfoliocraft'),
            'indent'   => true,
        ),
        array(
            'id'          => 'body_text_color',
            'type'        => 'color',
            'title'       => esc_html__('Body Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Main body text color used for paragraphs and general content.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#333333',
            'validate'    => 'color',
        ),
        array(
            ...
            'type'        => 'color',
            'title'       => esc_html__('Heading Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for all headings (H1, H2, H3, H4, H5, H6) and title elements.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#1a1a1a',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'post_title_color',
            'type'        => 'color',
            'title'       => esc_html__('Post Title Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for post titles, including single post titles and archive listings.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#1a1a1a',
            'validate'    => 'color',
        ),
        array(
            ...
            'type'        => 'color',
            'title'       => esc_html__('Subtitle Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for subtitles and secondary text elements.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#dd9933',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'meta_text_color',
            'type'        => 'color',
            'title'       => esc_html__('Meta Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for meta information like dates, authors, categories, and tags.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#999999',
            'validate'    => 'color',
        ),
        ...
        array(
            'id'       => 'comments_text_section',
            'type'     => 'section',
            'title'    => esc_html__('Comments Section Colors', 'portfoliocraft'),
            'subtitle' => esc_html__('Configure colors for comments section elements.', 'portfoliocraft'),
            'indent'   => true,
        ),
        array(
            'id'          => 'comments_title_color',
            'type'        => 'color',
            'title'       => esc_html__('Comments Title Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for comments section titles like "One Comment", "Leave a Comment".', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#1a1a1a',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'comment_author_color',
            'type'        => 'color',
            'title'       => esc_html__('Comment Author Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for comment author names.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#333333',
            'validate'    => 'color',
        ),
        array(
            ...
            'type'        => 'color',
            'title'       => esc_html__('Comment Text Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for comment content text.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#555555',
            'validate'    => 'color',
        ),
        array(
            'id'          => 'comment_meta_color',
            'type'        => 'color',
            'title'       => esc_html__('Comment Meta Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Color for comment dates, reply links, and other meta information.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#999999',
            'validate'    => 'color',
        ),
