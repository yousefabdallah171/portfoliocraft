...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id'          => 'body_bg_color',
            'type'        => 'color',
            'title'       => esc_html__('Background Color', 'portfoliocraft'),
            'subtitle'    => esc_html__('Main background color for your website pages.', 'portfoliocraft'),
            'transparent' => false,
            'default'     => '#ffffff',
            'validate'    => 'color',
        ),
