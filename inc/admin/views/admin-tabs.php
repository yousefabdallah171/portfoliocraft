 ...
 */
$portfoliocraft_core_active = class_exists('rmttheme_Core') || function_exists('pixelart');
 ...
 */
$dashboard_page_url = admin_url('admin.php?page=rmtart');
...
$plugin_page_url = admin_url('admin.php?page=rmtart-plugins');
$ocdi_page_url = admin_url('themes.php?page=one-click-demo-import');
$theme_options_page_url = admin_url('admin.php?page=rmtart-theme-options');
$system_status_page_url = admin_url('admin.php?page=Rakmyat-system-status');
$templates_page_url = admin_url('edit.php?post_type=rmt-template');
...
<nav class="rmt-dsb-menubar">
    ...
    <div class="rmt-dsb-menu">
        ...
        <ul class="rmt-dsb-menu-left">
            ...
            -->
            <li class="<?php echo (isset($_GET['page']) && 'rmtart' === sanitize_text_field($_GET['page'])) ? 'is-active' : ''; ?>">
            ...
            -->
            <li class="<?php echo (isset($_GET['page']) && 'rmtart-plugins' === sanitize_text_field($_GET['page'])) ? 'is-active' : ''; ?>">
            ...
            -->
            <li class="<?php echo (isset($_GET['page']) && 'rmtart-theme-options' === sanitize_text_field($_GET['page'])) ? 'is-active' : ''; ?>">
            ...
            <!-- 
                ...
                Only shown when portfoliocraft Core plugin is active
            -->
            <li class="<?php echo (isset($_GET['post_type']) && 'rmt-template' === sanitize_text_field($_GET['post_type'])) ? 'is-active' : ''; ?>">
        ...
        <ul class="rmt-dsb-menu-right">
            ...
            -->
            <li>
                <a href="<?php echo esc_url($rmt_server_info['video_url']); ?>" target="_blank">
            ...
            -->
            <li>
                <a href="<?php echo esc_url($rmt_server_info['demo_url']); ?>" target="_blank">
            ...
            <li>
                <a href="<?php echo esc_url($rmt_server_info['docs_url']); ?>" target="_blank">
                    <i class="rmt-icn-ess icon-md-help-circle"></i>
