...
// 3. .rmt-title-text (post titles)
// CSS: .rmt-title-text { color: var(--post-title-color, #1a1a1a) !important; }
...
// 2. Find "Main Text Colors" section → Change "Post Title Color" for .rmt-title-text
...
<h2 class="rmt-post-title">
    <span class="rmt-title-text">Hello world!</span>
</h2>
